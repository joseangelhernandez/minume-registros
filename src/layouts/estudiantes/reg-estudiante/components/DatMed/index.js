...
function DatMed({ formData }) {
  ...
  const { telefono_padres, condicion_medica, alergias, medicamentos_recomendados} = formField;
  const { 
        ...
        <Grid container spacing={1}>
          ...
          <Grid item xs={12}>
            <FormField
              ...
              value={medicamentos_recomendadosV}
