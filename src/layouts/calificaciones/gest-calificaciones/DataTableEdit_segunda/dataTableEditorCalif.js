...
function CalifTable(calificaciones) {
  ...
  const columns = [
    ...
    { title: "PENL", field: "pen_logico", type: 'numeric',
      validate: rowData => rowData.pen_logico >=  0 ? (rowData.pen_logico <= 50 ? true : 'La calificación debe estar entre 0 y 50') : 'La calificación debe estar entre 0 y 50' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    { title: "ARG", field: "argumentacion", type: 'numeric',
      validate: rowData => rowData.argumentacion >=  0 ? (rowData.argumentacion <= 50 ? true : 'La calificación debe estar entre 0 y 50') : 'La calificación debe estar entre 0 y 50' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    ?{ title: "Confirmación director adj.", field: "confir_dir_ad2",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad2",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
    ...
    calificaciones.tblEstuCalif.length < 11
    ?{ title: "Confirmación control y ev.", field: "confir_ce2",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce2",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsControl = [
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce2",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsAdj = [
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad2",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  function EnviarCalificaciones(){
    try{
      jwtInterceoptor.put('https://minume-umnurd.edu.do/api/USUARIOROLE_SP/'+`${auth.usuario}?sesion_trabajo=3`)
      .then(()=> {
  ...
  function ActivarEnvios(){
    ...
    calificaciones.Lista_usuarios.forEach(element => {
      try{
        jwtInterceoptor.put('https://minume-umnurd.edu.do/api/USUARIOROLE_SP/'+`${element.usuario}?sesion_trabajo=2`);
      }catch(error){
        console.log(error);
      }
      itemsProcesados++;
  ...
  return (
    <MaterialTable
      title="Segunda sesión de trabajo" 
      data={data} 
      columns={
