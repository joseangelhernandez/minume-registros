...
import BasicInfo from "layouts/participantes/reg-participante/components/BasicInfo";
import Procedencia from "layouts/participantes/reg-participante/components/Procedencia";

// NewUser layout schemas for form and form feilds
import validations from "layouts/participantes/reg-participante/schemas/validations";
import form from "layouts/participantes/reg-participante/schemas/form";
import initialValues from "layouts/participantes/reg-participante/schemas/initialValues";
...
function getStepContent(stepIndex, formData) {
  switch (stepIndex) {
    ...
    case 1:
      return <Procedencia formData={formData} />;
    default:
      return null;
  }
}
...
function NewUser() {
  ...
  const url = "https://minumeapi.azurewebsites.net/api/PARTICIPANTE"
