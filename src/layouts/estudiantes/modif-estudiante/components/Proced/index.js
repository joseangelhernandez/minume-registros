...
function Proced({ formData, estudiantePut, id  }) {
  ...
  useEffect(()=>{
    ...
    if(values.regional == ''){
      values.ide2 = id;
      values.regional = estudiantePut.regional
      values.distrito = estudiantePut.distrito
      values.centro_educativo = estudiantePut.centro_educativo
      values.grado = estudiantePut.grado
    }else if(values.ide2 != id){
      values.ide2 = id;
      values.regional = estudiantePut.regional
      values.distrito = estudiantePut.distrito
      values.centro_educativo = estudiantePut.centro_educativo
