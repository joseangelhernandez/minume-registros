...
import FormField from "layouts/usuarios/modif-usuario/components/FormField";
import FormFieldPassword from "layouts/usuarios/modif-usuario/components/FormFieldPassword";
import FormFieldSelect from "layouts/usuarios/modif-usuario/components/FormFieldSelect";

function UserInfo({ formData, usuarioPut, id }) {
 ...
 useEffect(()=>{
  if(values.cedula == ''){
    ...
    values.rol = usuarioPut.roleId
    values.contraseña = usuarioPut.contraseña
    values.repetirContraseña = usuarioPut.contraseña
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
              <FormFieldSelect
                ...
                success={values.rol > 0 && !errors.rol}
              />
          </Grid>
        </Grid>
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            <FormFieldPassword
              ...
              success={contraseñaV.length > 0 && !errors.contraseña}
              endAdornment={
