...
function CalifTable(calificaciones) {
  ...
  const columns = [
    ...
    { title: "DESP", field: "des_personal", type: 'numeric',
      validate: rowData => rowData.des_personal >=  0 ? (rowData.des_personal <= 50 ? true : 'La calificación debe estar entre 0 y 50') : 'La calificación debe estar entre 0 y 50' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    { title: "LID", field: "liderazgo", type: 'numeric',
      validate: rowData => rowData.liderazgo >=  0 ? (rowData.liderazgo <= 50 ? true : 'La calificación debe estar entre 0 y 50') : 'La calificación debe estar entre 0 y 50' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    ?{ title: "Confirmación director adj.", field: "confir_dir_ad4",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad4",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
    ...
    calificaciones.tblEstuCalif.length < 11
    ?{ title: "Confirmación control y ev.", field: "confir_ce4",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce4",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsControl = [
    ...
    { title: "DESP", field: "des_personal", type: 'numeric', editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    { title: "LID", field: "liderazgo", type: 'numeric', editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce4",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsAdj = [
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad4",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  function PostCalif(record){
    if(auth.ocupacion == 'CONTROL Y EVALUACION'){
      jwtInterceoptor.post(url+`/CUARTACE/${record.delegado}`+`/${record.confir_ce4}`).then(()=>{
        jwtInterceoptor.get(url+`/${calificaciones.sesion_trabajoTBL.comision}`)
        .then(response => {
          setData(response.data);
      })
      ...
      jwtInterceoptor.post(url+`/CUARTADIRAD/${record.delegado}`+`/${record.confir_dir_ad4}`).then(()=>{
        jwtInterceoptor.get(url+`/${calificaciones.sesion_trabajoTBL.comision}`)
        .then(response => {
          setData(response.data);
      })
      ...
      jwtInterceoptor.post(url+`/CUARTADIRAD/${record.delegado}`+`/${record.confir_dir_ad4}`).then(()=>{
        ...
        jwtInterceoptor.post(url+`/CUARTA/${record.delegado}`+`/${record.des_personal}`+`/${record.liderazgo}`)
        .catch(() => {
        let timerInterval
        Swal.fire({
          icon: 'error',
  ...
  function EnviarCalificaciones(){
    try{
      jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${auth.usuario}?sesion_trabajo=5`)
      .then(()=> {
  ...
  function DesactivarEnvios(){
    ...
    calificaciones.Lista_usuarios.forEach(element => {
      try{
        jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${element.usuario}?sesion_trabajo=5`);
      }catch(error){
        console.log(error);
      }
      itemsProcesados++;
  ...
  return (
    <MaterialTable
      title="Cuarta sesión de trabajo" 
      data={data} 
      columns={
      ...
      actions={data.length>10
        ...
        :calificaciones.sesion_trabajoTBL.sesion_trabajo === 4 && calificaciones.sesion_trabajoTBL.roleid > 1
        ?{  
