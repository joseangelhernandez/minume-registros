...
function CalifTable(calificaciones) {
  ...
  const columns = [
    ...
    { title: "COM", field: "comunicativa", type: 'numeric',
      validate: rowData => rowData.comunicativa >=  0 ? (rowData.comunicativa <= 40 ? true : 'La calificación debe estar entre 0 y 40') : 'La calificación debe estar entre 0 y 40' ,
      headerStyle: {
        width: '10px',
        fontSize: '0.8rem',
        fontWeight: '700',
    ...
    { title: "ORA", field: "oratoria", type: 'numeric',
      validate: rowData => rowData.oratoria >=  0 ? (rowData.oratoria <= 40 ? true : 'La calificación debe estar entre 0 y 40') : 'La calificación debe estar entre 0 y 40' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    { title: "RED", field: "redaccion", type: 'numeric',
      validate: rowData => rowData.redaccion >=  0 ? (rowData.redaccion <= 20 ? true : 'La calificación debe estar entre 0 y 20') : 'La calificación debe estar entre 0 y 20' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
  ...
  function EnviarCalificaciones(){
    try{
      jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${auth.usuario}?sesion_trabajo=2`)
      .then(()=> {
  ...
  function ActivarEnvios(){
    ...
    calificaciones.Lista_usuarios.forEach(element => {
      try{
        jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${element.usuario}?sesion_trabajo=1`);
      }catch(error){
        console.log(error);
      }
      itemsProcesados++;
  ...
  return (
    <MaterialTable
      ...
      actions={data.length>10
        ...
        :calificaciones.sesion_trabajoTBL.sesion_trabajo === 1 && calificaciones.sesion_trabajoTBL.roleid > 1
        ?{  
