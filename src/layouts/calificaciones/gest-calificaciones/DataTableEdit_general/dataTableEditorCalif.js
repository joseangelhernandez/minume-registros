...
function CalifTable(calificaciones) {
  ...
  const columns = [
    ...
    { title: "STARPOINT", field: "starpoint", type: 'numeric',
      validate: rowData => rowData.starpoint >=  1 ? (rowData.starpoint <= 5 ? true : 'El StarPoint debe estar entre 1 y 5') : 'El StarPoint debe estar entre 1 y 5' ,
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    ?{ title: "Confirmación director adj.", field: "confir_dir_ad5",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad5",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
    ...
    calificaciones.tblEstuCalif.length < 11
    ?{ title: "Confirmación control y ev.", field: "confir_ce5",editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce5",type: 'boolean',editable: 'never',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsControl = [
    ...
    { title: "STARPOINT", field: "starpoint", type: 'numeric',editable: 'never',
      headerStyle: {
        fontSize: '0.8rem',
        fontWeight: '700',
        opacity: '0.7',
    ...
    :{ title: "Confirmación control y ev.", field: "confir_ce5",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  const columnsAdj = [
    ...
    :{ title: "Confirmación director adj.", field: "confir_dir_ad5",type: 'boolean',
    headerStyle: {
      fontSize: '0.8rem',
      fontWeight: '700',
      opacity: '0.7',
  ...
  function PostCalif(record){
    if(auth.ocupacion == 'CONTROL Y EVALUACION'){
      jwtInterceoptor.post(url+`/FINALCE/${record.delegado}`+`/${record.confir_ce5}`).then(()=>{
      ...
      jwtInterceoptor.post(url+`/FINALDIRAD/${record.delegado}`+`/${record.confir_dir_ad5}`).then(()=>{
        jwtInterceoptor.get(url+`/${calificaciones.sesion_trabajoTBL.comision}`)
        .then(response => {
          setData(response.data);
      })
      ...
      jwtInterceoptor.post(url+`/FINAL/${record.delegado}`+`/${record.starpoint}`)
      .catch(() => {
        let timerInterval
        Swal.fire({
          icon: 'error',
  ...
  function EnviarCalificaciones(){
    try{
      jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${auth.usuario}?sesion_trabajo=0`)
      .then(()=> {
  ...
  function DesactivarEnvios(){
    ...
    calificaciones.Lista_usuarios.forEach(element => {
      try{
        jwtInterceoptor.put('https://minumeapi.azurewebsites.net/api/USUARIOROLE_SP/'+`${element.usuario}?sesion_trabajo=0`);
      }catch(error){
        console.log(error);
      }
      itemsProcesados++;
