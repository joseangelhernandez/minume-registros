...
import FormFieldSelect from "layouts/participantes/modif-participantes/components/FormFieldSelect";

function BasicInfo({ formData, participantePut, id }) {
 ...
 useEffect(()=>{
  if(values.nombre == ''){
    values.ide = id;
    values.nombre = participantePut.nombre
    values.cedula = participantePut.cedula
    values.email = participantePut.email
    values.sexo = participantePut.sexo
    values.telefono = participantePut.telefono
