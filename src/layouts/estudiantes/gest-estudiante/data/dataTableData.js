...
/*useEffect(() => {
    const expensesListResp = async () => {
      await axios.get('http://jose03-001-site1.htempurl.com/api/tablaESTUDIANTE')
      .then(
  ...
  const expensesListResp = async () => {
    const resultado = await axios.get('http://jose03-001-site1.htempurl.com/api/tablaESTUDIANTE')
  }
 ...
 /*axios.get('http://jose03-001-site1.htempurl.com/api/tablaESTUDIANTE').then((response)=> {
